...
public class DoctorDetails extends javax.swing.JFrame {
    ...
    private void customInit(){
        ...
        dtm.addColumn("Phone numbers");
        dtm.addColumn("Gender");
        
        
        Object[] rowData = {"15", "Vuqar nesirov", "1991", "26", "Stomotolog", "stom", "0506047289", "Male"};
        dtm.addRow(rowData);
        dtm.addRow(rowData);
        dtm.addRow(rowData);
        dtm.addRow(rowData);
        ...
        dtm.addRow(rowData);
        dtm.addRow(rowData);
        dtm.addRow(rowData);dtm.addRow(rowData);
        dtm.addRow(rowData);
        dtm.addRow(rowData);
        dtm.addRow(rowData);
        dtm.addRow(rowData);
        ...
        jTableDoctors.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            @Override
            public void valueChanged(ListSelectionEvent e) {
                System.out.println(jTableDoctors.getValueAt(jTableDoctors.getSelectedRow(), 0).toString());
            }
        });
        
        jTableDoctors.setModel(dtm);
    }
